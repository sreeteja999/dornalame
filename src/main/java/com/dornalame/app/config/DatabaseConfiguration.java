package com.dornalame.app.config;

import com.dornalame.app.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.dornalame.app.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.dornalame.app.repository.search")
